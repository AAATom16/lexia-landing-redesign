...
const LEXIA_ICONS = {
  ...
  medal: '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.4" stroke-linecap="round" stroke-linejoin="round"><path d="M9 3.2 12 9.8M15 3.2 12 9.8"/><circle cx="12" cy="15.6" r="5.8"/><text x="12" y="18.4" text-anchor="middle" font-size="7.4" font-weight="700" fill="currentColor" stroke="none" font-family="Nunito, Arial, sans-serif">1</text></svg>',
